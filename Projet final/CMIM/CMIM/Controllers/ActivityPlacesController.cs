...
namespace Cmim.Controllers
{
    ...
    public class ActivityPlacesController : ControllerBase
    {
        ...
        public ActivityPlacesController(CmimDBContext context)
        {
			...
			{
				_context.ActivityPlace.Add(new ActivityPlace { name="Act1" });
				_context.ActivityPlace.Add(new ActivityPlace { name = "Act2" });
				_context.ActivityPlace.Add(new ActivityPlace { name = "Act3" });
				_context.ActivityPlace.Add(new ActivityPlace { name = "Act4" });
