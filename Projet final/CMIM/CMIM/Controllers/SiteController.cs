...
namespace CMIM.Controllers
{
    ...
    public class SiteController : ControllerBase
    {
        ...
        public SiteController(CmimDBContext context)
        {
            ...
            {
                _context.sites.Add(new Site { name = "site1" });
                _context.sites.Add(new Site { name = "site2" });
                _context.sites.Add(new Site { name = "site3" });
                _context.sites.Add(new Site { name = "site4" });
