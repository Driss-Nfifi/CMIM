...
import EnhancedTable1 from '../Etats/EtatAvance';
...
class MiniDrawer extends React.Component {
  ...
  render() {
    ...
    const { auth, anchorEl,isLoad } = this.state;
    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <Divider />
          <List>
          <NavLink to="/tableau_de_borde" style={{textDecoration:"none"}}><ListItem button key="chart"
...
<Link to="/MyDropzone" style={{ textDecoration: "none" }}>
...
<Link to="/Emplo" style={{ textDecoration: "none" }}>
            ...
            <Link to="/EtatReguli" style={{ textDecoration: "none" }}>
                <ListItem button key="rembourssement" selected={this.state.selectedIndex === 24}
                    onClick={event => this.handleListItemClick(event, 24)}>
                        ...
                        <ListItemText primary="L’état de régularisations"  />
                </ListItem>
            </Link>
          ...
          <div className={classes.toolbar} />
            <div>
               <Switch>
                    ...
                    <Route exact path="/EtatAvance" component={EnhancedTable1} />
                    ...
                    <Route exact path="/MyDropzone" component={MyDropzone} />
