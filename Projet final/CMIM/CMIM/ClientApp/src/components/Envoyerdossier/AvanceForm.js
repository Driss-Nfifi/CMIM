            ...
            buttons: [
              {
                ...
                onClick: () => {
                    ...
                    pdf.text(30, 30, "Liste des dossiers envoyés à la CMIM");
                    var row = [];
                    for (var i = 0; i < this.state.data.length; i++) {
                        ...
                        dos.push(this.state.data[i].employee.first_name);
                        dos.push(this.state.data[i].employee.last_name);
                    ...
                    pdf.autoTable({
                        head: [['Numéro dossiers CMIM', 'Matricule CMIM', 'Matricule employé', 'Nom ', 'Prénom','Nom ', 'Mt Dossier ']],
                        body: row
